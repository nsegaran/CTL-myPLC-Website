...
const Categories = () => {
    ...
    <div className="categories-container">
      <div className="category">
        ...
        <div className="subcategory">
          <div className="subcategory-title">Contact Info & Nomenclature</div>
          <ul>
        ...
        <div className="subcategory">
          <div className="subcategory-title">Training Materials & Onboarding</div>
        ...
        <div className="subcategory">
          <div className="subcategory-title">Guidelines & Resources for Working at the CTL</div>
        ...
        <div className="subcategory">
          <div className="subcategory-title">Miscellaneous</div>
  ...
  <div className="subcategory">
          <div className="subcategory-title">General</div>
  ...
  <div className="subcategory">
          <div className="subcategory-title">Workshop Materials</div>
  ...
  <div className="subcategory">
          <div className="subcategory-title">Content Creation Guidelines</div>
...
<div className="category">
  ...
  <div className="subcategory">
          <div className="subcategory-title">Specific Guidelines & Resources</div>
  ...
  <div className="subcategory">
          <div className="subcategory-title">Templates</div>
  ...
  <div className="subcategory">
          <div className="subcategory-title">Specific Training</div>
  ...
  <div className="subcategory">
          <div className="subcategory-title">Current Quarter Materials</div>
